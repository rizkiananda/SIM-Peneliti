...
@section('title', 'SIMPEL - Detail Publikasi Buku')
@section('styles')
...
<div class="container">
	<ol class="breadcrumb">
		...
		<li><a href="/getPubbuku/{{$pubbuku->id}}">Publikasi Buku</a></li>
		<li class="active">Detail Publikasi Buku</li>
	</ol>
